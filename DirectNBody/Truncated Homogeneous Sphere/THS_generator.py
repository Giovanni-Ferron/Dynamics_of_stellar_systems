...
#Print command to run the NBody code
print('./nbody_sh1 -d 0.08 -e 0.01 -o 0.01 -t 0.5 < ' + 
      '"../Truncated Homogenous Sphere/Input/' + path + '".in"' +
      ' > "../Truncated Homogenous Sphere/Output/' + path + '."out"')
...
x_0, y_0, z_0, r, phi, theta = GenInput(N, m_i, a, generate)
